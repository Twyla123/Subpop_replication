...
try:
    from accelerate.utils import is_ccl_available          # accelerate <0.33
except ImportError:
    try:
        from accelerate.utils import is_xccl_available as is_ccl_available  # accelerate ≥0.33
    except ImportError:
        def is_ccl_available() -> bool:                    # fallback: always use nccl
            return False
